...
## 1) ChatGPT — Plano de aula completo (+ rubrica e transparência) - Autor Prof. Gabriel Vieira
...
## 2) Copilot no Word — Formatar, comentar e traduzir um trecho curto (internacionalização) - - Autor Prof. Gabriel Vieira
Formate este documento com Títulos H1–H3, listas numeradas e uma tabela para a rubrica. Onde houver [Assistido por IA], converta em comentários explicando o motivo do uso de IA e a revisão humana aplicada. Em seguida, selecione um trecho de 120–150 palavras do material e gere revisão inteligente + tradução para Inglês (CEFR A2). Adicione uma breve nota: “Como usar este trecho com estudantes multilíngues”. Marque a tradução com [Assistido por IA – Tradução]. Não inclua dados pessoais e padronize a linguagem para o público do 6º ano.

## 3) ChatGPT — Materiais didáticos (textos, exercício e atividade em grupo) - Autor Prof. Gabriel Vieira
Crie materiais complementares para “Frações e Representações Visuais” (Matemática, 6º ano):
...
## 4) ChatGPT — Adaptação para 2 perfis de alunos (personalização) - Autor Prof. Gabriel Vieira
...
## 5) Copilot no PowerPoint — Apresentação - Autor Prof. Gabriel Vieira
Leia o plano de aula anexado e gere uma apresentação .pptx para o tema “Frações e Representações Visuais” (Matemática, 6º ano).

## 6) ChatGPT — README.md do repositório (+ reflexão pronta) - Autor Prof. Gabriel Vieira
...
## 7) ChatGPT — Auditoria de ética/privacidade e checklist final - Autor Prof. Gabriel Vieira
